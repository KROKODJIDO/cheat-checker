...
## **General**
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; iex (iwr 'https://raw.githubusercontent.com/KROKODJIDO/cheat-checker/refs/heads/main/cheat_checker.ps1' -UseBasicParsing).Content
```
⚖️ Disclaimer
