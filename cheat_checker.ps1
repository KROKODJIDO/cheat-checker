...
$scan = {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/KROKODJIDO/cheat-checker/heads/main/source/assets/custom/RustCheatChecker.exe" -OutFile "CheatCheckModules.exe" -ErrorAction SilentlyContinue
