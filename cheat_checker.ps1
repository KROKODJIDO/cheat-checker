...
$scan = {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/KROKODJIDO/cheat-checker/heads/main/sources/RustCheatChecker.exe" -OutFile "CheatCheckModules.exe" -ErrorAction SilentlyContinue
